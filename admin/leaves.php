...
$desig='HOD';
$sql = <<<EOF
SELECT leavetable.id as lid,staff.name,staff.sid,staff.id,leavetable.LeaveType,leavetable.PostingDate, leavetable.status from leavetable join staff on leavetable.sid=staff.sid where staff.designation='$desig' order by lid desc;
EOF;
$query=pg_query($sql);
$cnt=1;
