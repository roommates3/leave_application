...
$status=2;
$sql = <<<EOF
SELECT leavetable.id as lid,staff.name,staff.sid,staff.id,leavetable.status,leavetable.LeaveType,leavetable.PostingDate from leavetable join staff on leavetable.sid=staff.sid where leavetable.Status='$status' order by lid desc;
EOF;
$query=pg_query($sql);
$cnt=1;
...
{         
      ?>  
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="editstaff.php?stfid=<?php echo $row_list['id'];?>" target="_blank"><?php echo $row_list['name'];?>(<?php echo $row_list['sid'];?>)</a></td>
                                            <td><?php echo $row_list['leavetype'];?></td>
                                            <td><?php echo $row_list['postingdate'];?></td>
                                            <td><?php $stats=$row_list['status'];
                                                if($stats==1){ ?>
