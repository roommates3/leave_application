...
$con=<<<EOF
update staff set Password='$newpassword' where id='$stfid';
EOF;
$query=pg_query($con);
...
<html lang="en">
    <head>
        ...
        <!-- Title -->
        <title>Leave Management System | Password Recovery</title>
                                       ...
                                       <div class="row">
                                           <form class="col s12" name="signin" method="post">
                                               <div class="input-field col s12">
                                                   <input id="sid" type="text" name="sid" class="validate" autocomplete="off" required >
                                                   <label for="email">Staff Id</label>
                                               </div>
                                               <div class="input-field col s12">
                                                   <input id="password" type="text" class="validate" name="gmailid" autocomplete="off" required>
...
$email=$_POST['gmailid'];
$sql =<<<EOF
SELECT id FROM staff WHERE gmailid='$email' and sid='$sid';
EOF;
$query=pg_query($sql);
