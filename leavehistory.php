                    ...
                    <div class="card stats-card">
                        <div class="card-content">
                            ...
                            <span class="stats-counter"><span
                                    class="counter"><?php echo htmlentities($clcount);?></span></span>
                        </div>
                ...
                <div class="col-12 col-lg-3">
                    <div class="card stats-card">
                        <div class="card-content">
                            ...
                            <span class="stats-counter"><span
                                    class="counter"><?php echo htmlentities($sclcount);?></span></span>
                        </div>
                        <div id="sparkline-line"></div>
                    </div>
                </div>
                ...
                <div class="col-12 col-lg-3">
                    <div class="card stats-card">
                        <div class="card-content">
                            ...
                            <span class="stats-counter"><span
                                    class="counter"><?php echo htmlentities($mlcount);?></span></span>
                        </div>
                        <div id="sparkline-line"></div>
                    </div>
                </div>
                ...
                <div class="col-12 col-lg-3">
                    <div class="card stats-card">
                        <div class="card-content">
                            ...
                            <span class="stats-counter"><span
                                    class="counter"><?php echo htmlentities($elcount);?></span></span>
                        </div>
                ...
                <div class="col-12 col-lg-3">
                    <div class="card stats-card">
                        <div class="card-content">
                            ...
                            <span class="stats-counter"><span
                                    class="counter"><?php echo htmlentities($remcl);?></span></span>
                        </div>
                        <div id="sparkline-line"></div>
                    </div>
                </div>
                ...
                <div class="col-12 col-lg-3">
                    <div class="card stats-card">
                        <div class="card-content">
                            ...
                            <span class="stats-counter"><span
                                    class="counter"><?php echo htmlentities($remscl);?></span></span>
                        </div>
                        <div id="sparkline-line"></div>
                    </div>
                </div>
                ...
                <div class="col-12 col-lg-3">
                    <div class="card stats-card">
                        <div class="card-content">
                            ...
                            <span class="stats-counter"><span
                                    class="counter"><?php echo htmlentities($remml);?></span></span>
                        </div>
                        <div id="sparkline-line"></div>
                    </div>
                </div>
                ...
                <div class="col-12 col-lg-3">
                    <div class="card stats-card">
                        <div class="card-content">
                            ...
                            <span class="stats-counter"><span
                                    class="counter"><?php echo htmlentities($remel);?></span></span>
                        </div>
                        <div class="progress stats-card-progress">
                            <div class="determinate" style="width: 50%"></div>
                        </div>
